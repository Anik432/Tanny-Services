report 50012 " Posted Sales Invoice Shpment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Sales - Invoice - Copy.rdlc';
    Caption = 'Posted Sales - Invoice without Shipment Details';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(PostingDt_SalesInvHeader; FORMAT("Sales Invoice Header"."Posting Date"))
                    {
                    }
                    ...
                    column(SalesInvHeaderYourReference; "Sales Invoice Header"."External Document No.")
                    {
                    }
                    ...
                    column(DocumentDate04_SalesInvHeader; FORMAT("Sales Invoice Header"."Shipment Date"))
                    {
                    }
            ...
            begin
                ...
                SubTotal := "Sales Invoice Header".Amount;
                GrandTotal := "Sales Invoice Header"."Amount Including VAT";
